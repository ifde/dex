...
```
forge script script/DeployHook.s.sol ABHook 0 0 --rpc-url http://localhost:8545 --broadcast
```
...
`Usual testing`
```
forge test -vvvv --match-path test/testHook.t.sol --gas-limit 10000000000
```
